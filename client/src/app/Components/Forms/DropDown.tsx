  ...
  return (
    ...
    >
      <div className='w-full'>
        ...
        <select
          className={` flex-auto border-none font-Montserrat text-base my-auto lg:text-lg placeholder:capitalize placeholder:text-gray-400   pb-2 pt-1  w-full h-auto block bg-transparent focus-within:outline-none  text-black dark:text-white`}
